...
- [x] The gap under the section rule now matches the rest of the page. It was 44px against 24px everywhere else, because the carousel carried 20px of its own padding on top of the header's spacing. The padding came from the article component, where it leaves room for the rounded corners to breathe; with square corners it was only adding a gap. Removed from the top and kept below, where it still separates the photos from the dots. Most Read sits at 40px and is the one section still out of step, left alone since it was not part of this pass.
